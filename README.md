...
[![CI](https://github.com/ansible-collections/ibm.csm/workflows/CI/badge.svg?event=push)](https://github.com/ansible-collections/ibm.csm/actions/workflows/ansible-test.yml) 
...
Tested with the current Ansible 2.10, 2.11, 2.12 releases and the current development version of Ansible. Ansible versions before 2.9.10 are not supported.
